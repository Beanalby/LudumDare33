...
public class ShowControls : MonoBehaviour {
    ...
    /// <summary>
    /// Hide after a specified number of seconds.
    /// </summary>
    /// <param name="delay">Seconds to wait before hiding</param>
    public void Hide(float delay) {
        StartCoroutine(__hideDelayed(delay));
    }

    private IEnumerator __hideDelayed(float delay) {
